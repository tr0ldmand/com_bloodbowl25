...
?>
<p>
<form method="POST" action="<?php echo JRoute::_('index.php?view=teamslist'); ?>">

<?php echo JText::_('COM_BLOODBOWL_LIMIT_SHOWING_TO'); ?>: 
<select name="show"><?php
	echo $this->ekstraoption;
	echo "<option value=\"0\" ". ($this->showteams==0 ? 'selected':'') .">". JText::_( 'COM_BLOODBOWL_ALL_TEAMS') ."</option>";
	echo "<option value=\"-1\" ". ($this->showteams==-1 ? 'selected':'') .">". JText::_( 'COM_BLOODBOWL_OWN_TEAMS') ."</option>";
?>
</select>&nbsp;
<select name="races">
	<option value="all"><?php echo JText::_( 'COM_BLOODBOWL_ALL_RACES'); ?></option>
	<?php
