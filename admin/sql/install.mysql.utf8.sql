...
CREATE TABLE IF NOT EXISTS `#__bb_tourneys` (
  ...
  `fame_rating` INT( 2 ) NOT NULL DEFAULT  '25',
...
INSERT INTO `#__bb_roster` (`id`, `race`, `max`, `position`, `move`, `strength`, `agility`, `armor`, `skills`, `normal`, `double`, `cost`, `icon`) VALUES
...
INSERT INTO `#__bb_skills` (`name`, `type`) VALUES
('Catch', 'A'),
('Diving Catch', 'A'),
('Diving Tackle', 'A'),
('Dodge', 'A'),
