...
--
-- Vært: 127.0.0.1
-- Genereringstid: 22. 10 2013 kl. 20:45:06
...
--
-- Database: `trcdk_jooha`
--
CREATE DATABASE IF NOT EXISTS `trcdk_jooha` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `trcdk_jooha`;

-- --------------------------------------------------------

--
-- Struktur-dump for tabellen `gd8h_bb_matches`
--

DROP TABLE IF EXISTS `gd8h_bb_matches`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_matches` (
...
--
-- Struktur-dump for tabellen `gd8h_bb_match_data`
--

DROP TABLE IF EXISTS `gd8h_bb_match_data`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_match_data` (
...
--
-- Struktur-dump for tabellen `gd8h_bb_players`
--

DROP TABLE IF EXISTS `gd8h_bb_players`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_players` (
...
--
-- Struktur-dump for tabellen `gd8h_bb_roster`
--

DROP TABLE IF EXISTS `gd8h_bb_roster`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_roster` (
...
--
-- Struktur-dump for tabellen `gd8h_bb_skills`
--

DROP TABLE IF EXISTS `gd8h_bb_skills`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_skills` (
...
--
-- Struktur-dump for tabellen `gd8h_bb_teams`
--

DROP TABLE IF EXISTS `gd8h_bb_teams`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_teams` (
...
--
-- Struktur-dump for tabellen `gd8h_bb_teams_in_tourney`
--

DROP TABLE IF EXISTS `gd8h_bb_teams_in_tourney`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_teams_in_tourney` (
...
--
-- Struktur-dump for tabellen `gd8h_bb_tourneys`
--

DROP TABLE IF EXISTS `gd8h_bb_tourneys`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_tourneys` (
...
--
-- Struktur-dump for tabellen `gd8h_bb_tourneys_in_tourneys`
--

DROP TABLE IF EXISTS `gd8h_bb_tourneys_in_tourneys`;
CREATE TABLE IF NOT EXISTS `gd8h_bb_tourneys_in_tourneys` (
...
--
-- Data dump for tabellen `gd8h_bb_roster`
--

INSERT INTO `gd8h_bb_roster` (`id`, `race`, `max`, `position`, `move`, `strength`, `agility`, `armor`, `skills`, `normal`, `double`, `cost`, `icon`) VALUES
...
--
-- Data dump for tabellen `gd8h_bb_skills`
--

INSERT INTO `gd8h_bb_skills` (`name`, `type`) VALUES
('Catch', 'A'),
('Diving Catch', 'A'),
('Diving Tackle', 'A'),
('Dodge', 'A'),
